...
export default function AddTime() {
  ...
  const tracks = [
    ...
    { value: 'paris-promenade', label: 'Paris Promenade' },
    { value: 'toad-circuit', label: 'Toad Circuit' },
    { value: 'choco-mountain', label: 'Choco Mountain' },
    { value: 'coconut-mall', label: 'Coconut Mall' },
    { value: 'tokyo-blur', label: 'Tokyo Blur' },
    { value: 'shroom-ridge', label: 'Shroom Ridge' },
    { value: 'sky-garden', label: 'Sky Garden' },
    { value: 'ninja-hideaway', label: 'Ninja Hideaway' },
    { value: 'new-york-minute', label: 'New York Minute' },
    { value: 'mario-circuit-3', label: 'Mario Circuit 3' },
    { value: 'kalamri-desert', label: 'Kalamri Desert' },
    { value: 'waluigi-pinball', label: 'Waluigi Pinball' },
    { value: 'sydney-sprint', label: 'Sydney Sprint' },
    { value: 'snow-land', label: 'Snow Land' },
    { value: 'mushroom-gorge', label: 'Mushroom Gorge' },
    { value: 'sky-high-sundae', label: 'Sky-High Sundae' },
    { value: 'london-loop', label: 'London Loop' },
    { value: 'boo-lake', label: 'Boo Lake' },
    { value: 'rock-rock-mountain', label: 'Rock Rock Mountain' },
    { value: 'maple-treeway', label: 'Maple Treeway' },
    { value: 'berlin-byways', label: 'Berlin Byways' },
    { value: 'peach-garden', label: 'Peach Garden' },
    { value: 'merry-mountain', label: 'Merry Mountain' },
    { value: '3DS-rainbow-road', label: '3DS Rainbow Road' },
    { value: 'amsterdam-drift', label: 'Amsterdam Drift' },
    { value: 'riverside-park', label: 'Riverside Park' },
    { value: 'dk-summit', label: 'DK Summit' },
    { value: 'yoshis-island', label: "Yoshi's Island" },
    { value: 'bangkok-rush', label: 'Bangkok Rush' },
    { value: 'DS-mario-circuit', label: 'DS Mario Circuit' },
    { value: 'waluigi-stadium', label: 'Waluigi Stadium' },
    { value: 'singapore-speedway', label: 'Singapore Speedway' },
  ];
